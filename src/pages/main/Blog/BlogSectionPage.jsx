          ...
          <div className="text-black/80 space-y-6">
            ...
            >
              <p className="text-base/7 sm:text-lg/8 md:text-lg/9 text-black/80 font-secondary font-medium">
                Ideas spark change, and strategies make it last. The Ayatiworks
                Blog is where we share both industry insights, data-backed
                strategies, and stories that empower businesses to grow.
              </p>
              <p className="text-base/7 sm:text-lg/8 md:text-lg/9 text-black/80 font-secondary font-medium">
