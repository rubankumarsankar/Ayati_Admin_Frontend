    ...
    <section className="section bg-white">
      <div className="section-container mx-auto px-4 text-center">
        ...
        <p className="text-secondary font-secondary  max-w-3xl mx-auto text-lg leading-relaxed">
          Digital PR is not a one-size-fits-all approach. At Ayatiworks, we
          bring together multiple facets of digital communications to help your
          brand gain visibility, authority, and trust online. Our services are
          designed to complement each other and create measurable impact.
        </p>
