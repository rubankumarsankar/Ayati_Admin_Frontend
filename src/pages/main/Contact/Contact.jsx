      ...
      >
         {/* Left Side - Heading + Icon + Image */}
          ...
          <span className="block h-1 w-24 bg-blue-700 mt-1 mx-auto md:mx-0"></span>
                ...
                <div className="max-w-3xl text-gray-600 leading-relaxed md:w-2/3 text-center md:text-left">
                 <h2 className="text-4xl font-bold text-blue-900">Ready to Build Something Forward?</h2>
                 <p className="mt-4">Whether you’re refining your digital presence or starting from scratch, we're here to make it happen. Drop us a line, let’s craft an unforgettable experience.</p>
                </div>
