...
export default function PartnersInClimb() {
  ...
  return (
    <section className="bg-white py-12 px-4 md:px-12 lg:px-20 overflow-hidden">
      ...
      >
        <h2 className="text-2xl md:text-3xl font-bold text-blue-900 relative inline-block">
          Our Partners in Climb
          <span className="block h-1 w-28 bg-blue-700 mt-1 mx-auto"></span>
        </h2>
        <img
          src="/icons/climb-man.png"
          alt="climb"
          className="mx-auto mt-2 w-12 md:w-16"
        />
      </motion.div>
